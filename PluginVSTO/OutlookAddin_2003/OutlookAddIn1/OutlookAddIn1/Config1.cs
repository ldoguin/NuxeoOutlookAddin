...
namespace OutlookAddIn1
{
    public partial class Config1 : Form
    {
        ...
        private void buttonTest_Click(object sender, EventArgs e)
        {
            ...
            {
                FormError bob = new FormError(ex.ToString(), "Le plugin n'est pas parvenu à se connecter au serveur nuxeo suivant : " + Config1.xmlRootNode().ChildNodes.Item(0).InnerText
        ...
        private void SaveXML()
        {
            ...
            try
            {
                ...
                XmlNode rootNode;
                if (nodes.Item(0).Name == "Root")
                {
                    rootNode = nodes.Item(0);
                }
                else
                {
                    rootNode = nodes.Item(1);
                }
        ...
        public static XmlNode xmlRootNode()
        {
            ...
            else //if (nodes.Item(0).Name == "Root")
            {
                rootNode = nodes.Item(1);
            }
